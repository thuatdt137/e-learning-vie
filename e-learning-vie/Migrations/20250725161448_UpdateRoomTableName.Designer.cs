...
namespace e_learning_vie.Migrations
{
    ...
    [Migration("20250725161448_UpdateRoomTableName")]
    partial class UpdateRoomTableName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("e_learning_vie.Models.StudentScore", b =>
                {
                    ...
                    b.HasOne("e_learning_vie.Models.SubjectScore", "SubjectScore")
                        .WithMany("StudentScores")
                        .HasForeignKey("SubjectScoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
